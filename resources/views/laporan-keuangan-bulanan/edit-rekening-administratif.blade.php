...
<div class="card border-white" style="width: 100rem;">
    <div class="card-body">
        <h4 style="text-align:center;">Edit Rekening Administratif {{ \App\Models\InformasiPokokBprPelapor::namaBpr($sandi_bpr)->nama_bpr ?? '' }}</h4>

        <div style="height:40px" align="centre"></div>

        <form action="{{ url('rekening-administratif-update') }}" method="POST">@csrf
        ...
        <div class="form-group row">
		    <label class="col-md-3">Nominal</label>
			    <div class="col-md-7">
                <input type="text" name="nominal" class="form-control nominal" value="{{ number_format((int) $data->nominal) ?? ''}}">
		    </div>
	    </div>
