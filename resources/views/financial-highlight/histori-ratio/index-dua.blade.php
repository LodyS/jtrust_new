    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">
                <label class="col-md-2">Pilih Tahun Awal</label>
                    <div class="col-md-5">
            ...
            <div class="form-group row">
                <label class="col-md-2">Pilih Tahun Akhir</label>
                    <div class="col-md-5">
            ...
            <div style="overflow-x:auto;">
                <table class="table table-hover table-responsive">
                    <tr>
                        ...
                        <th colspan="4" style="text-align:center;">{{ $tahun_tengah }}</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;">{{ ($d->pos == 'RASIO – RASIO %') ? '' : $d->jumlah_maret_dua. '%' }} </td>
                        <td style="text-align:right;">{{ ($d->pos == 'RASIO – RASIO %') ? '' : $d->jumlah_juni_dua. '%' }} </td>
                        <td style="text-align:right;">{{ ($d->pos == 'RASIO – RASIO %') ? '' : $d->jumlah_september_dua. '%' }} </td>
                        <td style="text-align:right;">{{ ($d->pos == 'RASIO – RASIO %') ? '' : $d->jumlah_desember_dua. '%' }} </td>
                    </tr>
                    @endforeach
