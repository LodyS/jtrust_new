...
<div class="card border-white" style="width: 100rem;">
    <div class="card-body">
        <h5 align="center">IMPOR LAPORAN POSISI KEUANGAN  <br/>{{ strtoupper($nama_bpr = \App\Models\InformasiPokokBprPelapor::namaBpr($sandi_bpr)->nama_bpr ?? '') }}</h5>
        ...
        <form action="{{ url('import-laporan-posisi-keuangan') }}" method="POST"  enctype="multipart/form-data">@csrf
        ...
        <input type="hidden" class="form-control" name="jenis_laporan" value="Laporan Posisi Keuangan" >
