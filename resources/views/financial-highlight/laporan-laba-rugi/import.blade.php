...
<div class="card border-white" style="width: 100rem;">
    <div class="card-body">
        <h5 align="center">IMPORT LAPORAN LABA RUGI <br/>{{ strtoupper($nama_bpr = \App\Models\InformasiPokokBprPelapor::namaBpr($sandi_bpr)->nama_bpr ?? '') }}</h5>

        <div style="height:40px" align="centre"></div>

        <form action="{{ url('import-laporan-laba-rugi') }}" method="POST"  enctype="multipart/form-data">@csrf
        ...
        <input type="hidden" class="form-control" name="jenis_laporan" value="Laporan Laba Rugi" >
