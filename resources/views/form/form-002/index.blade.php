...
<div class="card border-white" style="width: 100rem;">
    <div class="card-body">
        ...
        <h4>Form 002 - Data Anggota Direksi dan Komisaris BPR</h4>

        <div style="height:40px" align="centre"></div>

        <form action="{{ url('simpan-data-anggota-direksi-dan-komisaris-bpr') }}" method="POST"  enctype="multipart/form-data">@csrf
